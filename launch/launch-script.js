// Glyppo Launch Promotional Layout - Screenshot Helper
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  console.log('- Use number keys 1-5 to select panels');
  console.log('- Press Escape to clear selection');
  console.log('- Selected panels will have a coral outline');
});
